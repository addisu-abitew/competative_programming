class Router:
    ...
    # Plan
        # store the packets for each destination with ordered time stamp
            # destinations = {dest: set((source, timestamp))}
        # save all packetss in FIFO
            # packets = []
        # count with sorted timestap for each destination
    ...
    def getCount(self, destination: int, startTime: int, endTime: int) -> int:
        timestamps = self.counts[destination]
